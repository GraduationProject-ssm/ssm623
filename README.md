...
# ssm623一家运动鞋店的产品推广网站的设计+jsp

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=23)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本一家运动鞋店也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让考试信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，一家运动鞋店的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，一家运动鞋店是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此一家运动鞋店为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
# 4 系统设计
## 4.1 总体功能
一家运动鞋店是根据需求定制开发，开发软件选用Myeclipse平台配合MySQL数据库进行开发环境的搭建操作，网站采用WEB应用程序中最流行的B/S结构进行开发，用户访问系统数据仅仅需要在客户端安装谷歌浏览器或者是当下常用浏览器就可以访问网站内容。
## 4.2 系统概要设计
...
图4.2 程序工作的原理图
## 4.3 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.3展示的就是管理员功能结构图，管理员在后台主要管理收货地址管理、购物车管理、字典管理、留言版管理、新闻信息管理、产品管理、产品收藏管理、产品评价管理、产品订单管理、单页数据管理、用户管理、管理员管理等。
...
![C:\Users\Administrator\Desktop\img\yundongxiedian\用户.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\用户.jpg")
图4.1 用户实体属性图

（2）下图是留言版实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\留言版.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\留言版.jpg")
图4.2 留言版实体属性图

（3）下图是购物车实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\购物车.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\购物车.jpg")
图4.3 购物车实体属性图

（4）下图是新闻信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\新闻信息.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\新闻信息.jpg")
图4.4 新闻信息实体属性图

（5）下图是产品实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\产品.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\产品.jpg")
图4.5 产品实体属性图

（6）下图是单页数据实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\单页数据.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\单页数据.jpg")
图4.6 单页数据实体属性图

（7）下图是产品收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\产品收藏.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\产品收藏.jpg")
图4.7 产品收藏实体属性图

（8）下图是产品评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\产品评价.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\产品评价.jpg")
图4.8 产品评价实体属性图

（9）下图是产品订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\产品订单.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\产品订单.jpg")
图4.9 产品订单实体属性图

（10）下图是收货地址实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yundongxiedian\收货地址.jpg](/md/blog.018.jpeg "C:\Users\Administrator\Desktop\img\yundongxiedian\收货地址.jpg")
图4.10 收货地址实体属性图
### 4.4.2 数据库表结构设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shangpin\_uuid\_number|String|产品编号|是|
|3|shangpin\_name|String|产品名称|是|
|4|shangpin\_photo|String|产品照片|是|
|5|shangpin\_types|Integer|产品类型|是|
|6|shangpin\_kucun\_number|Integer|产品库存|是|
|7|shangpin\_old\_money|BigDecimal|产品原价|是|
|8|shangpin\_new\_money|BigDecimal|现价|是|
|9|shangpin\_clicknum|Integer|点击次数|是|
|10|shangpin\_content|String|产品介绍|是|
...
## 5.1 管理员功能介绍
### 5.1.1 产品列表
如图5.1显示的就是产品列表页面，此页面提供给管理员的功能有：查看产品、新增产品、修改产品、删除产品等。

![](/md/blog.019.png)

图5.1 产品列表页面
### 5.1.2 新闻信息管理
新闻信息管理页面提供的功能操作有：新增新闻信息，修改新闻信息，删除新闻信息操作。下图就是新闻信息管理页面。

![](/md/blog.020.png)

图5.3 新闻信息管理页面
### 5.1.3新闻信息类型管理
新闻信息类型管理页面显示所有新闻信息类型，在此页面既可以让管理员添加新的新闻信息类型，也能对已有的新闻信息类型信息执行编辑更新，失效的新闻信息类型信息也能让管理员快速删除。下图就是新闻信息类型管理页面。
